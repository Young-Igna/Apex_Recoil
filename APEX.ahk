...
Gui, Font, s10
Gui, Add, Text, x30 y10, APEX IGNA
Gui, Font, s12
Gui, Font, cBLUE bold
Gui, Add, Text, x30 y+15, BINDS
Gui, Font, s10
Gui, Font, cWhite bold
Gui, Add, Text, x30 y+12, "F1" R301
Gui, Add, Text, x30 y+12, "F2" R99
Gui, Add, Text, x30 y+12, "F3" Alternator
Gui, Add, Text, x30 y+12, "F4" R45
Gui, Add, Text, x30 y+12, "F5" havoc
Gui, Add, Text, x30 y+12, "F6" ProwlerSelect
Gui, Add, Text, x30 y+12, "F7" Volt
Gui, Add, Text, x30 y+12, "F8" Flatline
Gui, Add, Text, x30 y+12, "F9" Spidfire
Gui, Add, Text, x30 y+12, "F10" Lstar
Gui, Add, Text, x30 y+12, "F11" Devotion
Gui, Add, Text, x30 y+12, "F12" DevotionSelect
Gui, Add, Text, x30 y+12, "Numepad1" HavocSelect
Gui, Add, Text, x30 y+12, "Numepad2" Hemlok
Gui, Add, Text, x30 y+12, "Numepad3" Scout/p2020/wigman
Gui, Font, cRED bold
Gui, Font, s10
Gui, Add, Text, x30 y+12, "5" Reset Script

Gui, -AlwaysOnTop
Gui, Color, Black
Gui, Show, w700 h520, No Recoil Script
